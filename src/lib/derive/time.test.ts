...
describe("dailyTotals", () => {
  it("aggregates multiple sessions per day and sorts ascending", () => {
    const days = dailyTotals([session("2024-01-02", 100), session("2024-01-01", 50), session("2024-01-02", 200)]);
    expect(days).toEqual([
...
describe("longestStreak", () => {
  ...
  it("finds the longest run across gaps and month boundaries", () => {
    const days = [day("2024-01-30", 1), day("2024-01-31", 1), day("2024-02-01", 1), day("2024-02-03", 1), day("2024-02-04", 1)];
...
describe("sessionLengthHistogram", () => {
  it("buckets session durations", () => {
    const buckets = sessionLengthHistogram([session("2024-01-01", 5), session("2024-01-01", 3 * 60_000), session("2024-01-01", 45 * 60_000), session("2024-01-01", 3 * 3_600_000)]);
...
describe("biggestDays", () => {
  it("ranks days by total time and reports the top products", () => {
    const sessions = [session("2024-01-01", 100, "A"), session("2024-01-02", 500, "B"), session("2024-01-02", 300, "C"), session("2024-01-02", 50, "D")];
